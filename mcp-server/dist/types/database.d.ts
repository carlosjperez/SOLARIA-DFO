...
export type ProjectStatus = 'planning' | 'development' | 'testing' | 'deployment' | 'review' | 'completed' | 'on_hold' | 'cancelled';
export type TaskStatus = 'pending' | 'in_progress' | 'review' | 'completed' | 'blocked';
export type Priority = 'critical' | 'high' | 'medium' | 'low';
export type AgentStatus = 'active' | 'busy' | 'idle' | 'inactive' | 'offline' | 'error' | 'maintenance';
export type UserRole = 'ceo' | 'cto' | 'coo' | 'cfo' | 'admin' | 'manager' | 'developer';
