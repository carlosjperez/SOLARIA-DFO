...
export class PlaywrightClient {
    ...
    async screenshot(options = {}) {
        const manager = getMCPClientManager();
        const result = await manager.executeTool(this.serverName, 'browser_take_screenshot', {
...
// Factory Function
// ============================================================================
let playwrightClientInstance = null;
/**
 * Get singleton Playwright client
 */
export function getPlaywrightClient(config) {
 ...
 */
export function resetPlaywrightClient() {
    if (playwrightClientInstance) {
