...
var epics_js_1 = require("./epics.js");
...
exports.tasks = (0, mysql_core_1.mysqlTable)('tasks', {
    ...
    projectId: (0, mysql_core_1.int)('project_id').references(function () { return projects_js_1.projects.id; }, { onDelete: 'cascade' }),
    epicId: (0, mysql_core_1.int)('epic_id').references(function () { return epics_js_1.epics.id; }, { onDelete: 'set null' }),
    sprintId: (0, mysql_core_1.int)('sprint_id').references(function () { return sprints_js_1.sprints.id; }, { onDelete: 'set null' }),
    agentId: (0, mysql_core_1.int)('agent_id').references(function () { return agents_js_1.aiAgents.id; }, { onDelete: 'set null' }),
    assignedAgentId: (0, mysql_core_1.int)('assigned_agent_id').references(function () { return agents_js_1.aiAgents.id; }, { onDelete: 'set null' }),
    assignedBy: (0, mysql_core_1.int)('assigned_by').references(function () { return users_js_1.users.id; }, { onDelete: 'set null' }),
...
exports.taskItems = (0, mysql_core_1.mysqlTable)('task_items', {
    ...
    taskId: (0, mysql_core_1.int)('task_id')
        .notNull()
        .references(function () { return exports.tasks.id; }, { onDelete: 'cascade' }),
    ...
    completedAt: (0, mysql_core_1.timestamp)('completed_at'),
    completedByAgentId: (0, mysql_core_1.int)('completed_by_agent_id').references(function () { return agents_js_1.aiAgents.id; }, {
        onDelete: 'set null',
    }),
...
exports.taskTagAssignments = (0, mysql_core_1.mysqlTable)('task_tag_assignments', {
    ...
    tagId: (0, mysql_core_1.int)('tag_id')
        .notNull()
        .references(function () { return exports.taskTags.id; }, { onDelete: 'cascade' }),
    assignedBy: (0, mysql_core_1.int)('assigned_by').references(function () { return users_js_1.users.id; }, { onDelete: 'set null' }),
...
exports.taskItemsRelations = (0, drizzle_orm_1.relations)(exports.taskItems, function (_a) {
    var one = _a.one;
    return ({
...
exports.taskTagAssignmentsRelations = (0, drizzle_orm_1.relations)(exports.taskTagAssignments, function (_a) {
    var one = _a.one;
    return ({
        task: one(exports.tasks, {
