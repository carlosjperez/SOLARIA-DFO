 ...
 */
export declare const userRoleEnum: import("drizzle-orm/mysql-core").MySqlEnumColumnBuilderInitial<"role", ["ceo", "cto", "coo", "cfo", "admin", "viewer", "manager", "agent"]>;
export declare const users: import("drizzle-orm/mysql-core").MySqlTableWithColumns<{
    ...
    columns: {
        ...
        role: import("drizzle-orm/mysql-core").MySqlColumn<{
            ...
            data: "admin" | "ceo" | "cto" | "coo" | "cfo" | "manager" | "agent" | "viewer";
            driverParam: string;
            notNull: true;
            hasDefault: true;
            isPrimaryKey: false;
            isAutoincrement: false;
            hasRuntimeDefault: false;
            enumValues: ["ceo", "cto", "coo", "cfo", "admin", "viewer", "manager", "agent"];
            baseColumn: never;
            identity: undefined;
            generated: undefined;
        }, {}, {}>;
