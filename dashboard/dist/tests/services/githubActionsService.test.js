...
describe('GitHubActionsService', () => {
    ...
    describe('Constructor', () => {
        test('should initialize Octokit client with provided token', () => {
            ...
            new Octokit(config);
            expect(Octokit).toHaveBeenCalledWith(expect.objectContaining({
                auth: 'ghp_test123',
                baseUrl: 'https://api.github.com',
                userAgent: 'SOLARIA-DFO/4.0',
            }));
    ...
    describe('triggerWorkflow()', () => {
        ...
        test('should handle GitHub API errors gracefully', async () => {
            mockOctokit.actions.createWorkflowDispatch.mockRejectedValue(new Error('GitHub API rate limit exceeded'));
    ...
    describe('getRunStatus()', () => {
        ...
        test('should handle GitHub API errors', async () => {
            mockOctokit.actions.getWorkflowRun.mockRejectedValue(new Error('Run not found'));
            await expect(async () => {
    ...
    describe('createIssue()', () => {
        ...
        test('should handle GitHub API errors gracefully', async () => {
            mockOctokit.issues.create.mockRejectedValue(new Error('Repository not found'));
            const expectedResult = {
                success: false,
    ...
    describe('createPR()', () => {
        ...
        test('should handle GitHub API errors gracefully', async () => {
            mockOctokit.pulls.create.mockRejectedValue(new Error('Head branch does not exist'));
            const expectedResult = {
                success: false,
        ...
        test('should handle label addition failures gracefully', async () => {
            ...
            mockOctokit.issues.addLabels.mockRejectedValue(new Error('Label does not exist'));
    ...
    describe('Error Handling', () => {
        ...
        test('should handle network timeouts', async () => {
            mockOctokit.actions.createWorkflowDispatch.mockRejectedValue(new Error('Request timeout'));
            const expectedError = {
                success: false,
 ...
 */
//# sourceMappingURL=githubActionsService.test.js.map